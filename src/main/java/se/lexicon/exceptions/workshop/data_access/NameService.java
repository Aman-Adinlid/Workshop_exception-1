...
public class NameService {
    ...
    public void addFemaleFirstName(String name) throws DuplicateNameException {
        ...
        if (femaleFirstNames.contains(name)) {
            throw new DuplicateNameException("enter addFemaleFirstName");
        } else
    ...
    public void addMaleFirstName(String name) throws DuplicateNameException, IOException {
        if (maleFirstNames.contains(name))
            throw new DuplicateNameException("Entered male first name");
        else
    ...
    public void addLastName(String lastName) throws DuplicateNameException, IOException {
        if (lastNames.contains(lastName)) {
            throw new DuplicateNameException("Entered last name");
        } else
